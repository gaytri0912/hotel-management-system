...
class HotelManagementSystem:
    def __init__(self, root):
        ...
        self.root.geometry("1550x650+0+0")
        ...
        reports_btn = Button(btn_frame,text="HLEPLINE:11110000",width=22,font=("times new roman",14,"bold"),bg="black",fg="white",bd=0,cursor="hand1")
