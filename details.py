...
class Detailsroom:
    def __init__(self,root):
        ...
        ################ Title ##################
        lbl_title = Label(self.root,text="HOTEL ROOM DETAILS",font=("times new roman",18,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
    ...
    def add_data(self):
        if self.var_floor.get()=="" or self.var_room_type.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="Gaytri09!",database="hotel_management")
